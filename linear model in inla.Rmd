...
First you get information about hte time used for running the model - useful for sptial models that can take a while.
...
Finally, lets predict from our model!
...
newdat$mu    <- FIT[,"mean"]       #Fitted values
newdat$selow <- FIT[,"0.025quant"] #Lower bound
newdat$seup  <- FIT[,"0.975quant"] #Upper bound
